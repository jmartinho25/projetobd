...
CREATE INDEX idx_Clube_ClubeID ON Clube (ClubeID);
...
CREATE INDEX idx_Nadador_NadadorID ON Nadador (NadadorID);
...
CREATE INDEX idx_Escalao_EscalaoID ON Escalao (EscalaoID);
...
CREATE INDEX idx_Prova_ProvaID ON Prova (ProvaID);
...
CREATE INDEX idx_Estafetas_EstafetasID ON Prova_Estafetas (EstafetasID); 
...
CREATE INDEX idx_Individuaç_IndividualID ON Prova_Individual (IndividualID); 
...
CREATE TABLE SplitIndividuais (
    ...
    TempoSplit TIME,
    DistanciaSplit INT,
    PRIMARY KEY (NadadorID, IndividualID),
    FOREIGN KEY (NadadorID) REFERENCES Nadador(NadadorID),
    FOREIGN KEY (IndividualID) REFERENCES Prova_Individual(IndividualID);
);
...
CREATE INDEX idx_Individuais_IndividualID ON Prova_Individual (IndividualID); 
